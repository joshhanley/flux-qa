...
{{-- <div class="h-screen"> --}}
    {{-- <flux:header sticky class="bg-gray-100">Test</flux:header> --}}
    {{-- <ui-sidebar
        state="expanded"
        collapsible="icon"
        stashable
    ...
    <flux:sidebar.collapsible sticky stashable collapsible="icon" class="bg-zinc-50 dark:bg-zinc-900 border-r rtl:border-r-0 rtl:border-l border-zinc-200 dark:border-zinc-700">
            <flux:button
                icon="x-mark"
